...
## creates the plot
plot(hp$Time, hp$Sub_metering_1,  type = "l", col="black",        ## adds ine for metering 1
     ylab = "Energy sub metering",                                ##  Adds the label to the Y axis
     xlab = ""                                                    ## Turns off Label for x Axis
     )
lines(hp$Time, hp$Sub_metering_2,   type = "l",col = "red")       ## adds ine for metering 2
lines(hp$Time, hp$Sub_metering_3,     type = "l", col="blue")     ## adds ine for metering 3
